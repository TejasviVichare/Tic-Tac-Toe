...
function closepopup(){
 ...
 function myfun(){
    ...
    var b1btn, b2btn, b3btn, b4btn, b5btn, b6btn, b7btn, b8btn, b9btn;
     ...
     //Checking that player x won or not and after that disabled all other fields

     if((b1=='x' || b1=='X') && (b2=='x' || b2=='X')  && (b3=='x' || b3=='X')){
        document.getElementById("print").innerHTML="Player X Won"
         document.getElementById("popup-main").style.visibility="visible";
        document.getElementById("player-name").innerHTML="Player X"
        b4btn.disabled = true;
        b5btn.disabled = true;
        b6btn.disabled = true;
        b7btn.disabled = true;
     ...
     //Checking that player O won or not and after that disabled all other fields

   else  if((b1=='0' || b1=='0') && (b2=='0' || b2=='0')  && (b3=='0' || b3=='0')){
      document.getElementById("print").innerHTML="Player 0 Won"
      document.getElementById("popup-main").style.visibility="visible";
      document.getElementById("player-name").innerHTML="Player 0"
      b4btn.disabled = true;
      b5btn.disabled = true;
      b6btn.disabled = true;
      b7btn.disabled = true;
